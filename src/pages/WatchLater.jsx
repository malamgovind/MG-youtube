...
import { getWatchLater, toggleWatchLater } from "../api/userData";
...
function WatchLater() {
    ...
    const handleRemove = async (e, video) => {
        ...
        await toggleWatchLater(user.uid, fakeVideo);
    ...
    if (!user) {
        return (
            <div className="text-center mt-16">
                ...
                <p className="text-gray-500 dark:text-gray-400">Login to see your Watch Later list.</p>
            </div>
        );
    }
    if (items.length === 0) {
        return (
            <div className="text-center mt-16">
                ...
                <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Save videos to watch them later.</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-3xl mx-auto pb-10 pt-2">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">
                Watch Later <span className="text-gray-400 font-normal text-lg">({items.length})</span>
            </h1>
